...
/**
 * Variacion de la clase archive del cargador para solucionar problemas. Represents an XLSX Archive
 *
 * @author    Antoine Guigan <antoine@akeneo.com>
 * @copyright 2014 Akeneo SAS (http://www.akeneo.com)
 * @license   http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class ArchiveReplace extends \Akeneo\Component\SpreadsheetParser\Xlsx\Archive {
	/**
	 *
	 * @var string
	 */
	...
	public function __destruct() {
		// esto no debe hacer nada, sino se pudre bien feo
	}
